  ...
  _getHeader: function _getHeader() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'th',
          { className: this.getClassName().headCellHeader, colSpan: '6', onClick: this.state.decade ? null : this._headerClick },
          this._getHeaderText()
        ),
        _react2.default.createElement(
          'th',
