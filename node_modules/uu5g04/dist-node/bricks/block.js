...
var Block = exports.Block = (0, _createReactClass2.default)({
  displayName: 'Block',
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Block"),
    nestingLevelList: UU5.Environment.getNestingLevelList('bigBoxCollection', 'box'),
    classNames: {
      main: _bricksNs2.default.css("block"),
      bg: _bricksNs2.default.css("block-bg")
    },
    opt: {
