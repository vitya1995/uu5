...
var _contextMenuItem = require('./context-menu-item.js');

var _contextMenuItem2 = _interopRequireDefault(_contextMenuItem);

require('./context-menu.less');

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ContextMenu = exports.ContextMenu = (0, _createReactClass2.default)({
  ...
  statics: {
    ...
    classNames: {
      main: _bricksNs2.default.css("context-menu"),
      ul: _bricksNs2.default.css("context-menu-ul")
    },
    defaults: {
  ...
  //@@viewOn:interface
  isContextMenu: function isContextMenu() {
    return true;
  },
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      _popover2.default,
      _extends({}, this._getMainAttrs(), { ref_: function ref_(menu) {
          return _this._menu = menu;
        }, parent: this }),
      _react2.default.createElement(
        'ul',
        { className: this.getClassName().ul },
        children
      )
    );
  }
...
ContextMenu.Item = _contextMenuItem2.default;
