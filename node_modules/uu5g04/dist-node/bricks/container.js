...
var Container = exports.Container = (0, _createReactClass2.default)({
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Container"),
    nestingLevelList: UU5.Environment.getNestingLevelList('container', 'bigBoxCollection'),
    classNames: {
      main: _bricksNs2.default.css("container"),
      spacing: _bricksNs2.default.css("container-spacing"),
      noSpacing: _bricksNs2.default.css("container-nospacing")
    }
  },
  //@@viewOff:statics
