...
var Image = exports.Image = (0, _createReactClass2.default)({
  displayName: 'Image',
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Image"),
    nestingLevelList: UU5.Environment.getNestingLevelList('bigBoxCollection', 'box'),
    classNames: {
      main: _bricksNs2.default.css("image"),
      type: _bricksNs2.default.css("image-"),
  ...
  //@@viewOn:propTypes
  propTypes: {
    type: _propTypes2.default.oneOf(['rounded', 'circle', 'thumbnail']),
  ...
  render: function render() {
    ...
    var image = _react2.default.createElement('img', mainAttrs);
