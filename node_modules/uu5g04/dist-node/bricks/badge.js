...
var Badge = exports.Badge = (0, _createReactClass2.default)({
  displayName: 'Badge',
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Badge"),
    nestingLevel: 'inline',
    classNames: {
      main: _bricksNs2.default.css("badge")
    }
  },
  //@@viewOff:statics
  ...
  render: function render() {
    ...
    return this.getNestingLevel() && children ? _react2.default.createElement(
      'span',
      this.getMainAttrs(),
      children,
