...
var Code_ = _factory2.default.createTag('code', '_code');

var Code = exports.Code = (0, _createReactClass2.default)({
  displayName: 'Code',
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Code"),
    nestingLevel: 'inline',
    classNames: {
      main: _bricksNs2.default.css("code")
    }
  },
  //@@viewOff:statics
