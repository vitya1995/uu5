...
var Icon = exports.Icon = (0, _createReactClass2.default)({
  displayName: 'Icon',
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Icon"),
    nestingLevel: 'inline',
    classNames: {
      main: _bricksNs2.default.css("icon"),
      notClickable: _bricksNs2.default.css("icon-notclickable")
    }
  },
  //@@viewOff:statics
  ...
  render: function render() {
    ...
    if (this.props.icon) {
      var splitter = this.props.icon.split('-');
      if (splitter) {
        var iconsName = splitter[0];
