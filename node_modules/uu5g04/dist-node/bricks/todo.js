...
var Todo = exports.Todo = (0, _createReactClass2.default)({
  displayName: 'Todo',
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Todo"),
    nestingLevel: 'box',
    classNames: {
      main: _bricksNs2.default.css("todo")
    },
    opt: {
  ...
  //@@viewOn:propTypes
  propTypes: {
    props: _propTypes2.default.oneOfType([_propTypes2.default.array, _propTypes2.default.object])
  },
  //@@viewOff:propTypes
  ...
  render: function render() {
    return this.getNestingLevel() ? _react2.default.createElement(
      UU5.Bricks.Section,
      _extends({}, this.getMainPropsToPass(), { content: null }),
