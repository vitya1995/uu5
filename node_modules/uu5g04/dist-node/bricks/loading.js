...
var Loading = exports.Loading = (0, _createReactClass2.default)({
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Loading"),
    nestingLevelList: UU5.Environment.getNestingLevelList('bigBoxCollection', 'inline'),
    classNames: {
      main: _bricksNs2.default.css("loading uu5-common-padding-xs"),
      animated: _bricksNs2.default.css("loading-animated"),
      inline: 'uu5-common-inline',
      dot: _bricksNs2.default.css("loading-dot")
    },
    opt: {
  ...
  _getDefaultContent: function _getDefaultContent() {
    return _react2.default.Children.toArray([1, 2, 3].map(function () {
      return _react2.default.createElement('span', { className: this.getClassName().dot });
    }.bind(this)));
  },
