...
var Ul = exports.Ul = (0, _createReactClass2.default)({
  displayName: 'Ul',
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name('Ul'),
    nestingLevelList: UU5.Environment.getNestingLevelList('bigBoxCollection', 'box'),
    classNames: {
      main: _bricksNs2.default.css('ul'),
      type: _bricksNs2.default.css('ul-type-')
    },
    defaults: {
  ...
  propTypes: {
    ...
    type: _propTypes2.default.oneOf(['disc', 'square', 'circle'])
  },
  //@@viewOff:propTypes
