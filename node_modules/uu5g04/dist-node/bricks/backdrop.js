...
var Backdrop = exports.Backdrop = (0, _createReactClass2.default)({
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Backdrop"),
    nestingLevelList: UU5.Environment.getNestingLevelList('bigBoxCollection', 'smallBox'),
    classNames: {
      main: _bricksNs2.default.css("backdrop"),
      background: _bricksNs2.default.css("backdrop-background")
    },
    opt: {
  ...
  render: function render() {
    ...
    if (typeof this.props.onClick === 'function') {
      mainAttrs.onClick = function (e) {
        return _this.props.onClick(_this, e);
      };
    }
    if (typeof this.props.onMouseOver === 'function') {
      mainAttrs.onMouseOver = function (e) {
        return _this.props.onMouseOver(_this, e);
      };
    }
