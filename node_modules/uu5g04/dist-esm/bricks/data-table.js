...
export const DataTable = createReactClass({
  ...
  propTypes: {
    ...
    headerRow: PropTypes.arrayOf(PropTypes.any //content props
    ),
    footerRow: PropTypes.arrayOf(PropTypes.any //content props
    ),
    rows: PropTypes.arrayOf(PropTypes.arrayOf(PropTypes.any //content props
    ))
  },
  //@@viewOff:propTypes
  ...
  render: function () {
    ...
    if (this.state.valid) {
      result = <Table {...this._getMainProps()} header={this.props.header} footer={this.props.footer} nestingLevel={this.getNestingLevel()}>
          {this._getHeaderRow()}
          {this._getBodyRows()}
          {this._getFooterRow()}
        </Table>;
