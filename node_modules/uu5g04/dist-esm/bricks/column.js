...
export const Column = createReactClass({
  ...
  _getMainAttrs() {
    ...
    if (this.props.width) {
      ...
      mainAttrs.className = mainAttrs.className + ' ' + UU5.Common.Tools.buildColWidthClassName(this.props.colWidth || this.getDefault().colWidth);
    }
