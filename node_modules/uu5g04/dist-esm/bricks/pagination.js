...
export const Pagination = createReactClass({
  ...
  _getItems() {
    ...
    let items = range.map(function (i) {
    ...
    if (this.getItemsLength() > this.props.range) {
      ...
      if (dotsLeft) {
        items.unshift(<li className={this.getClassName().item}><UU5.Bricks.Icon icon="mdi-dots-horizontal" className={this.getClassName("dots")} />
        </li>);
      }

      if (dotsRight) {
        items.push(<li className={this.getClassName().item}><UU5.Bricks.Icon icon="mdi-dots-horizontal" className={this.getClassName("dots")} />
        </li>);
      }
