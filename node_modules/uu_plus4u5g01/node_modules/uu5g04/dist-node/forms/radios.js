...
var Radios = exports.Radios = (0, _createReactClass2.default)({
  displayName: 'Radios',
  ...
  //@@viewOn:statics
  statics: {
    tagName: _formsNs2.default.name("Radios"),
    classNames: {
      main: _formsNs2.default.css("radios"),
  ...
  _getCheckboxes: function _getCheckboxes() {
    ...
    return this.props.value.map(function (box, key) {
      ...
      return _react2.default.createElement(_checkbox2.default, { size: _this.props.size, key: key, value: _this.getValue() === checkboxProps.name, label: box.label, onChange: _this._onChange, onIcon: box.onIcon || _this.props.onIcon || null, offIcon: box.offIcon || _this.props.offIcon || null, name: box.name, _radio: true, labelPosition: _this.props.labelPosition, disabled: disabled });
    });
  },
