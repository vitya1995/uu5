...
var Line = exports.Line = (0, _createReactClass2.default)({
  displayName: 'Line',
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Line"),
    nestingLevel: 'smallBox',
    classNames: {
      main: _bricksNs2.default.css("line uu5-common-bg"),
      size: _bricksNs2.default.css("line-size-")
    }
  },
  //@@viewOff:statics
