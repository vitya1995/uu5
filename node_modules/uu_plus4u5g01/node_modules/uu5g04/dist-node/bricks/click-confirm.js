...
exports.ClickConfirm = undefined;
...
require('./click-confirm.less');

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ClickConfirm = exports.ClickConfirm = (0, _createReactClass2.default)({
  displayName: 'ClickConfirm',
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("ClickConfirm"),
    nestingLevelList: UU5.Environment.getNestingLevelList('bigBoxCollection', 'inline'),
    classNames: {
      main: _bricksNs2.default.css("click-confirm"),
      open: _bricksNs2.default.css("click-confirm-shown")
    },
    defaults: {
      showTimeout: 500,
      closeTimeout: 4000
