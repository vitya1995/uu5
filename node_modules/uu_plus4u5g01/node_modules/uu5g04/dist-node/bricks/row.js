...
var Row = exports.Row = (0, _createReactClass2.default)({
  displayName: 'Row',
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Row"),
    nestingLevelList: ['spa', 'page', 'bigBoxCollection', 'bigBoxCollection', 'boxCollection', 'box', 'smallBoxCollection'],
    classNames: {
      main: _bricksNs2.default.css("row"),
      spacing: _bricksNs2.default.css("row-spacing"),
      noSpacing: _bricksNs2.default.css("row-nospacing"),
      standard: _bricksNs2.default.css("row-standard"),
      flex: _bricksNs2.default.css("row-flex")
    },
    opt: {
  ...
  propTypes: {
    ...
    display: _propTypes2.default.oneOf(['standard', 'flex'])
  },
  //@@viewOff:propTypes
