...
require('./blockquote-footer.less');
...
exports.default = (0, _createReactClass2.default)({
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Blockquote.footer"),
    nestingLevelList: UU5.Environment.getNestingLevelList('bigBoxCollection', 'box'),
    classNames: {
      main: _bricksNs2.default.css("blockquote-footer"),
      right: _bricksNs2.default.css("blockquote-footer-right"),
      left: _bricksNs2.default.css("blockquote-footer-left")
    },
    opt: {
