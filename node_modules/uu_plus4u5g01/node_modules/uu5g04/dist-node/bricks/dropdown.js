...
var Dropdown = exports.Dropdown = (0, _createReactClass2.default)({
  ...
  statics: {
    ...
    classNames: {
      ...
      split: _bricksNs2.default.css("dropdown-group", "button-group"),
      pullRight: _bricksNs2.default.css("dropdown-right"),
      pullRightMenu: _bricksNs2.default.css("dropdown-menu-right"),
      dropdownBtn: _bricksNs2.default.css("dropdown-button", "dropdown-toggle"),
      ...
      leave: _bricksNs2.default.css("dropdown-leave"),
      block: _bricksNs2.default.css("dropdown-block"),
      arrow: _bricksNs2.default.css("dropdown-arrow")
    },
    defaults: {
  ...
  _getButton: function _getButton() {
    ...
    if (Array.isArray(this.props.label)) {
      content = this.props.label.concat([arrow]);
    } else {
      content = [this.props.label, arrow];
    }
  ...
  render: function render() {
    ...
    var style = {
      ...
      right: 'auto',
      marginBottom: this.state.marginBottom + 5 || 0
    };
    if (this.props.pullRight) {
    ...
    return this.getNestingLevel() ? _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: this.getClassName().buttonCover, id: this.getId() + '-cover' },
        this._getButton(),
        this._getIconButton()
      ),
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { className: menuClass, ref: function ref(dropdownMenu) {
              return _this3._dropdownMenu = dropdownMenu;
            }, style: style },
          this._getChildren()
        )
      )
