...
var TagPlaceholder = exports.TagPlaceholder = (0, _createReactClass2.default)({
  ...
  _findLib: function _findLib(props) {
    ...
    if (library && library.error) {
      ...
      var query = _tools2.default.encodeQuery(dtoIn);
      url += query;

      if (!_environment2.default.tagCalls[query]) {
        _environment2.default.tagCalls[query] = [this._setComponent.bind(this, props.tagName, props.props)];

        var request = new XMLHttpRequest();
        request.onreadystatechange = function () {
          if (request.readyState === XMLHttpRequest.DONE) {
            var tagCalls = _environment2.default.tagCalls[query];
            delete _environment2.default.tagCalls[query];
        ...
        _environment2.default.tagCalls[query].push(this._setComponent.bind(this, props.tagName, props.props));
      }
    }
