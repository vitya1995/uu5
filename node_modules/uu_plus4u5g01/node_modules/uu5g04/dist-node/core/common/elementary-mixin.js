...
exports.ElementaryMixin = undefined;
...
var ElementaryMixin = exports.ElementaryMixin = {
  ...
  statics: {
    "UU5.Common.ElementaryMixin": {
      ...
      classNames: {
        hidden: _commonNs2.default.css("hidden"),
        selected: _commonNs2.default.css("selected"),
        disabled: _commonNs2.default.css("disabled"),
        disabledCover: _commonNs2.default.css("disabled-cover"),
        disabledCoverTransparent: _commonNs2.default.css("disabled-cover-transparent")
      }
    }
  },
  //@@viewOff:statics
  ...
  buildMainAttrs: function buildMainAttrs(mainAttrs) {
    var newMainAttrs = _tools2.default.mergeDeep({}, mainAttrs || this.getUU5CommonBaseMixinProps && this.getUU5CommonBaseMixinProps().mainAttrs, {
  ...
  getDisabledCover: function getDisabledCover() {
    ...
    return this.isDisabled() ? _react2.default.createElement('span', { className: className }) : null;
  },
...
exports.default = ElementaryMixin;