...
var BaseMixin = exports.BaseMixin = {
  ...
  propTypes: {
    ...
    tooltip: _propTypes2.default.any, // content - for now just string is valid
    className: _propTypes2.default.string,
    style: _propTypes2.default.oneOfType([_propTypes2.default.object, _propTypes2.default.string]),
    mainAttrs: _propTypes2.default.object,
    parent: _propTypes2.default.object,
    ref_: _propTypes2.default.func,
    noIndex: _propTypes2.default.bool
  },
  //@@viewOff:propTypes
  ...
  getInitialState: function getInitialState() {
    ...
    this.id = this.props.id === null ? _tools2.default.generateUUID() : this.props.id;
    // state
    return null;
  },
  ...
  // TODO: deprecated
  getLSI: function getLSI(item, mixinName) {
    _tools2.default.warning("Method this.getLSI is deprecated. Use this.getLsi instead.");
    return this.getLsi(item, mixinName);
  },
  getLsiComponent: function getLsiComponent(item, mixin, params) {
    return _tools2.default.findComponent('UU5.Bricks.Lsi', { lsi: this.getLsi(item, mixin), params: params });
  },


  // TODO: deprecated
  getLSIComponent: function getLSIComponent(item, mixin, params) {
    _tools2.default.warning("Method this.getLSIComponent is deprecated. Use this.getLsiComponent instead.");
    return this.getLsiComponent(item, mixin, params);
  },
  getLsiValue: function getLsiValue(item, mixin, params) {
    return _tools2.default.getLsiItemByLanguage(this.getLsi(item, mixin), params);
  },


  // TODO: deprecated
  getLSIValue: function getLSIValue(item, mixin, params) {
    _tools2.default.warning("Method this.getLSIValue is deprecated. Use this.getLsiValue instead.");
    return this.getLsiValue(item, mixin, params);
  },
  getLsiItem: function getLsiItem(value, params) {
    return (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' ? _tools2.default.getLsiItemByLanguage(value, params) : value;
  },


  // TODO: deprecated
  getLSIItem: function getLSIItem(value, params) {
    _tools2.default.warning("Method this.getLSIItem is deprecated. Use this.getLsiItem instead.");
  ...
  getLimit: function getLimit(item, mixinName) {
    var limits = mixinName ? _environment2.default.limits[mixinName] : this.constructor[mixinName] ? this.constructor[mixinName].limits : this.constructor.limits;
  ...
  getUU5CommonBaseMixinPropsToPass: function getUU5CommonBaseMixinPropsToPass(suffix) {
    ...
    var props = {
      ...
      style: this.props.style && this.props.mainAttrs && this.props.mainAttrs.style ? _tools2.default.mergeDeep(this.props.mainAttrs.style, this.props.style) : this.props.style || this.props.mainAttrs && this.props.mainAttrs.style,
      parent: this
    };
    ...
    if (mainAttrs && mainAttrs.className) {
      extend && (mainAttrs = _tools2.default.mergeDeep({}, mainAttrs)) && (extend = false);
    ...
    if (this.getTooltip()) {
      extend && (mainAttrs = _tools2.default.mergeDeep({}, mainAttrs));
  ...
  getMainPropsToPass: function getMainPropsToPass(mixinNames) {
    ...
    return _tools2.default.mergeDeep.apply(null, params);
  },

  getMainAttrs: function getMainAttrs() {
    var newMainAttrs = _tools2.default.mergeDeep({}, this.getUU5CommonBaseMixinProps().mainAttrs, {
      className: this.getFullClassName()
    });
    ...
    if (this.props.style) {
      ...
      newMainAttrs.style = _tools2.default.mergeDeep({}, newMainAttrs.style, style);
    }
  ...
  getFullClassName: function getFullClassName(className) {
    ...
    return _tools2.default.buildClasses(classes, classArray);
  },
  ...
  stringToObjectType: function stringToObjectType(string, type, prefix) {
    ...
    if ((typeof calculated === 'undefined' ? 'undefined' : _typeof(calculated)) !== type) {
      this.showError('tagIsWrong', string, {
        mixinName: "UU5.Common.BaseMixin",
        context: {
          notFoundObject: calculated,
          notFoundObjectType: typeof calculated === 'undefined' ? 'undefined' : _typeof(calculated),
          checkedType: type,
          prefix: prefix
        }
      });
  ...
  switchChildrenToBody: function switchChildrenToBody(props) {
    var newProps = _tools2.default.mergeDeep({}, props || this.props);
    var children = newProps.children;
    newProps.children = null;
    newProps.body = _react2.default.Children.map(children, _tools2.default.childToBodyItem());
    return newProps;
  },
  ...
  exportToObject: function exportToObject() {
    return {
      tag: this.getTagName(),
      props: _tools2.default.mergeDeep({}, this.props),
      state: _tools2.default.mergeDeep({}, this.state)
    };
  },
  ...
  showError: function showError(msgKey, msgParams, opt) {
    ...
    _tools2.default.error.apply(null, this.__getLogParams(msg, msgParams, opt.context));
    return this;
  },
  ...
  showWarning: function showWarning(msgKey, msgParams, opt) {
    ...
    _tools2.default.warning.apply(null, this.__getLogParams(msg, msgParams, opt.context));
    return this;
  },

  replaceByHardSpace: function replaceByHardSpace(text, language) {
    var replacer = language ? _environment2.default.hardSpace.lsiReplacer[language] : null;
    replacer = replacer || _tools2.default.getLsiItemByLanguage(_environment2.default.hardSpace.lsiReplacer);
  ...
  shouldRender: function shouldRender(nextProps, nextState, thisProps, thisState) {
    ...
    var oldProps = _tools2.default.merge({}, props);
    var newProps = _tools2.default.merge({}, nextProps);
    return !_tools2.default.deepEqual(oldProps, newProps) || !_tools2.default.deepEqual(state, nextState);
  },
  ...
  __getLogParams: function __getLogParams(msg, msgParams, context) {
    ...
    var msgWithParams = msg ? _tools2.default.formatString(msg, msgParams) : msgParams || null;
