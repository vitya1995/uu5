...
export const Swiper = createReactClass({
  ...
  //@@viewOn:render
  render: function () {
    return this.getNestingLevel() ? <div {...this.getMainAttrs()} onTouchStart={this.swipeOnTouchStart} onTouchMove={this.swipeOnTouchMove} onTouchEnd={this.swipeOnTouchEnd.bind(this, this._onSwipeEnd)}>
