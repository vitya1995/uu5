  ...
  _getHeader: function () {
    ...
    return <thead className={this.getClassName().thead}>
      <tr className={this.getClassName().headRow}>
        ...
        <th className={this.getClassName().headCellHeader} colSpan="6" onClick={this.state.decade ? null : this._headerClick}>
          {this._getHeaderText()}
        </th>
