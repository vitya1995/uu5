...
export const Time = createReactClass({
  ...
  _increaseStart(id) {
    this._increaseTimeout = setTimeout(() => {
      this._increaseTimer = setInterval(() => this._scrollUp(id), 100);
    }, 300);
  },
  ...
  _decreaseStart(id) {
    this._decreaseTimeout = setTimeout(() => {
      this._decreaseTimer = setInterval(() => this._scrollDown(id), 100);
    }, 300);
  },
  ...
  render() {
    ...
    return <div {...this.getMainAttrs()}>
        ...
        {this._isFormat12() && <div className={this.getClassName("timePart")}>
          ...
          content: <UU5.Bricks.Icon icon={this.state.pm ? "mdi-chevron-left" : "mdi-chevron-right"} className={"uu5-common-text " + (this.state.pm ? this.getClassName("iconPm") : this.getClassName("iconAm"))} />
        }} />
